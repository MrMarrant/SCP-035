...
SCP_035_CONFIG.Enabled035Vision = CreateConVar( "SCP035_Enabled035Vision", 1, {FCVAR_PROTECTED, FCVAR_ARCHIVE}, "Define if players will have the custom 035 vision", 0, 1 )
